...
Cloud Volumes ONTAP es un dispositivo de almacenamiento exclusivamente de software que ejecuta el software de gestión de datos ONTAP en el cloud. Proporciona almacenamiento de clase empresarial con las siguientes funciones clave para la próxima prueba:
