...
summary: Compruebe el archivo disk.raw descargado de Google Cloud con el contenido del archivo de resumen utilizando OpenSSL. 
---
...
[role="lead"]
Puede verificar el archivo disk.RAW descargado de Google Cloud con el contenido del archivo digest disponible en la https://mysupport.netapp.com/site/products/all/details/cloud-volumes-ontap/downloads-tab["NSS"^] Uso de OpenSSL.


NOTE: Los comandos OpenSSL para validar la imagen son compatibles con equipos Linux, Mac OS y Windows.

.Pasos
. Verifique el certificado con OpenSSL.
+
...
. Descifre la firma con la clave pública extraída y compruebe el contenido del archivo disk.raw descargado.
+
.Haga clic en para mostrar el script
[%collapsible]
====
