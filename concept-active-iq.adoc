...
Cambio para localización. Active docbot y pruebe la visualización de loc. Prueba de desactivación de docbot. Volver a probar la actualización de rubí por tercera vez. Prueba de empuje de actualización de rubí.
